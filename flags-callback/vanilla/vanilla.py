...
from charms.reactive import Flags, when
...
@when(flags.not_set(flags.vanilla_installed))
def install(self):
    # Handle resources.
...
@when(flags.all(flags.apache_installed,
                flags.not_set(flags.apache_configured)))
